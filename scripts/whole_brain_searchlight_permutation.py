"""
permutation searchlight script built directly 
from my current one, 
...
if OS_NAME == "Windows":
    ...
    BETAS_ROOT = Path("/home/rita/Elisabeth/singleN_betas")
    REPO_ROOT = Path("/home/rita/Elisabeth")
...
OUTDIR = (
    PROJECT_ROOT
    / "recog_task_whole_brain_searchlight_permutations_global"
)
...
TASK_FILTER = "recog" # passive or recog
