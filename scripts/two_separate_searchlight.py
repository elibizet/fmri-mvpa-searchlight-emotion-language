...
and doing leave-one-session-out within each block, I'm essentially asking:
...
OUTDIR = PROJECT_ROOT / "Splitting sessions(anxiety vs sadness) in video" / "within_recog_betas"
...
MODALITIES = ["video"]  # or ["audio","video","audiovisual"]
